...
classes = None
with open('utility\B3_RecognitionObjectYolo4\object_detection_classes_yolov4.txt', 'rt') as f:
...
try:
      ...
      st.session_state["Net"] = cv2.dnn.readNet('utility\B3_RecognitionObjectYolo4\yolov4.weights', 'utility\B3_RecognitionObjectYolo4\yolov4.cfg')
